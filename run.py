...
def init_param():
    ...
    output_dir = 'out/'
    language = 'vi'
    # the height of the produced images if horizontal, else the width
    format = 32
    # the number of thread to use for image generation
    thresh_count = 1
    # extension of output image
    extension = "jpg"
    # angle if word on output image is skewed
    skew_angle = 0
    # gaussian blur to the resulting sample
    gaussian_blur = 1
    # what kind of background to use. 0: Gaussian Noise, 1: Plain white, 2: Quasicrystal, 3: Image
    back_ground = 3
